  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      ...
      const aiResponse: Message = {
        ...
        text: "Thank you for your message! I'm your AI Assistant, ready to help you with any questions or support you need. How can I assist you today?",
        isUser: false,
        timestamp: formatTime(),
      };
            ...
            <AnimatePresence>
              {messages.map((message) => (
                <ChatMessage
                  ...
                  avatar={!message.isUser ? joyImage : undefined}
                />
              ))}
            </AnimatePresence>
            
            {isTyping && (
              <TypingIndicator avatar={joyImage} />
            )}
